...
const subcategories = ["Все", "Мальчики", "Девочки", "Малыши", "Верхняя одежда", "Обувь"];
...
export default function KidsCategoryPage() {
  ...
  const filteredProducts = useMemo(() => {
    let list = products.filter(p => p.gender === "kids");
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="mb-16">
            <nav className="flex items-center gap-2 text-[11px] md:text-[13px] tracking-wide text-slate-400 mb-8">
              ...
              <span>/</span>
              <span className="text-brand-blue font-bold">Дети</span>
            </nav>
